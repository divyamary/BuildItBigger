 ...
 * on 2016-04-08 at 12:48:13 UTC 
 * Modify at your own risk.
 */

package in.divyamary.builditbigger.backend.jokeApi;
...
public class JokeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetJoke extends JokeApiRequest<in.divyamary.builditbigger.backend.jokeApi.model.Joke> {
     ...
     */
    protected GetJoke() {
      super(JokeApi.this, "GET", REST_PATH, null, in.divyamary.builditbigger.backend.jokeApi.model.Joke.class);
    }
   ...
   *
   * @param content the {@link in.divyamary.builditbigger.backend.jokeApi.model.Joke}
   * @return the request
   */
  public InsertJoke insertJoke(in.divyamary.builditbigger.backend.jokeApi.model.Joke content) throws java.io.IOException {
    InsertJoke result = new InsertJoke(content);
    initialize(result);
    return result;
  }

  public class InsertJoke extends JokeApiRequest<in.divyamary.builditbigger.backend.jokeApi.model.Joke> {
     ...
     * @since 1.13
     */
    protected InsertJoke(in.divyamary.builditbigger.backend.jokeApi.model.Joke content) {
      super(JokeApi.this, "POST", REST_PATH, content, in.divyamary.builditbigger.backend.jokeApi.model.Joke.class);
    }
